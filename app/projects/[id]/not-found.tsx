...
const notFoundContent: Record<Language, { title: string; description: string; back: string }> = {
  en: {
  ...
  es: {
    ...
    description: "El proyecto que estás buscando no existe o fue eliminado.",
  ...
  ru: {
    ...
    description: "Проект, который вы ищете, не существует или был удален.",
    back: "Назад к Проектам",
  },
  zh: {
    title: "未找到项目",
    description: "你正在查找的项目不存在或已被移除。",
    back: "返回项目列表",
  },
}
