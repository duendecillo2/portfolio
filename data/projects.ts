...
export function useProjects() {
  ...
  const projects: Project[] = useMemo(() => [
    ...
    {
      id: "mundo-figus-store",
      title: t("projects.project3.title"),
      description: t("projects.project3.description"),
      longDescription: t("projects.project3.longDescription"),
      date: t("projects.project3.date"),
      techStack: ["Next.js", "NestJS", "PostgreSQL", "Docker", "Nginx", "CI/CD", "JWT", "Mercado Pago", "REST API"],
      demoUrl: "https://youtu.be/y7x6XbN12sE",
      codeUrl: "#",
      imageSrc: "/images/MFWEB1.Png",
      images: [
        "/images/MFWEB1.Png",
        "/images/MFWEB2.Png",
        "/images/MFWEB3.Png",
